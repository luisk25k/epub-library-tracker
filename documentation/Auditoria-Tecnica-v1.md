...
| ---- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| S-01 | **CRÍTICO** | El sistema carece de un mecanismo robusto para rotar o revocar de manera proactiva las credenciales externas en caso de exposición accidental. Debería definirse una política estricta de ciclo de vida para los secretos almacenados en el `.env`.                                                             | `.env:1`                                       |
