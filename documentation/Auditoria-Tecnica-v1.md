...
| ---- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| S-01 | **CRÍTICO** | API Key de Google Books hardcodeada en `.env` dentro del repositorio. Aunque `.env` está en `.gitignore`, si alguien ejecuta la app sin sobrescribir el `.env.example`, la key queda expuesta. Debería eliminarse del control de versiones.                                                                     | `.env:1`                                       |
